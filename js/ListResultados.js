$(document).ready(function () {
    ...
    if (idCanal) {
        ...
        $(".nav-pills a").first().addClass("active");
    }
    ...
    $("a[id*=linkArq]").each(function () {
        if ((!$.trim($(this).html()) == "") && ($(this).text().indexOf('PDF') != -1)) {
            if ($(this).hasClass("pdf")) {
                $(this).html('<img src="./images/icon-pdf.svg" alt="Download">');
            } else if ($(this).hasClass("ppt")) {
                $(this).html('<img src="./images/icon-ppt.svg" alt="Download">');
            } else if ($(this).hasClass("audio")) {
                $(this).html('<img src="./images/icon-audio.svg" alt="Download">');
            }
        }
        else if ((!$.trim($(this).html()) == "") && ($.trim($(this).text().indexOf('xlsx') != -1) || ($(this).text().indexOf('XLS') != -1))) {
            if ($(this).hasClass("Planilhas")) {
                $(this).html('<img src="./images/icon-xls.svg" alt="Download">');
            } else if ($(this).hasClass("audio")) {
                $(this).html('<img src="./images/icon-audio.svg" alt="Download">');
            }
